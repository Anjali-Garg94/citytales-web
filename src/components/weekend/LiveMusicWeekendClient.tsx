  ...
  return (
    <section className="overflow-hidden bg-[#0C0A09] pt-10 pb-12 lg:pt-14 lg:pb-16">
      <div className="lg:mx-auto lg:max-w-[1280px]">
        <div className="flex items-end justify-between px-5 lg:px-20">
          <div>
            <h2 className="font-serif text-2xl font-semibold text-white lg:text-[32px]">
              Live music &amp; parties
            </h2>
          </div>
          <Link
        ...
        <div className="mt-5 flex gap-2 px-5 lg:px-20">
          {TABS.map((t) => {
            const active = t === tab;
            return (
              <button
        ...
        {events.length > 0 ? (
          ...
          <div className="mx-5 mt-8 rounded-[18px] border border-white/15 px-5 py-12 text-center lg:mx-20">
